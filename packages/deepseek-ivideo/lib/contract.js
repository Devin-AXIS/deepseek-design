...
//#endregion
//#region ../../../packages/video-studio/src/host.ts
const IPOLLOWORK_VIDEO_STUDIO_FEATURES = {
	voice: true,
	designSystem: true,
	templates: false
};
//#endregion
export { HYPERFRAMES_VERSION, IPOLLOWORK_VIDEO_STUDIO_FEATURES, VIDEO_STUDIO_HOST_CHANNEL, hyperframesStudioPort, hyperframesStudioUrl, isVideoStudioHostMessage, parseHyperframesAskAiMessage, resolveVideoAiSelectionTarget, videoProjectDirectory, videoProjectEntryPath, videoProjectId, videoStudioDocumentPrompt, videoStudioSelectionPrompt };
