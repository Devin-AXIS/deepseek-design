...
This directory mirrors the thin DeepSeek Harness adapters and shared Studio contracts from [iPolloWork](https://github.com/Devin-AXIS/iPolloWork/tree/cf7fe7e3c24caa7c299d26f7a1c7ba8eb9b2db4f). The complete, directly installable runtime is in `packages/`.
